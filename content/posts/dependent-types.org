...
* Static typing
Certain languages are considered "statically-typed." This means the compiler is aware of data-types at compile-time. Python and JavaScript are *not* statically-typed but C, Java, Haskell, and Rust /are/.
